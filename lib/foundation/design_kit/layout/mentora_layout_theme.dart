...
/// The Layout Tokens Adapter — shared by the whole family.
///
...
/// handed, which is none. Everything else belongs to the components it
/// composes, and each of them keeps its own adapter.
final class MentoraLayoutTheme {
  ...
  /// RELATION, declined by the family's own factor.
  double get panelGap =>
