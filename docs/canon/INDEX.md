...
| Production Closure Package — Foundation Completion (5 docs) | [`publication/packages/production-closure/`](publication/packages/production-closure/) → [01](publication/packages/production-closure/01-foundation-completion-certificate.md) · [02](publication/packages/production-closure/02-foundation-completion-manifest.md) · [03](publication/packages/production-closure/03-foundation-identity.md) · [04](publication/packages/production-closure/04-foundation-version.md) · [05](publication/packages/production-closure/05-foundation-status.md) | **projeté** (Lot 6A — Foundation COMPLÈTE) |
