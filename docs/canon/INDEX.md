...
type: apparatus
titre: canon
statut: "R2-Corpus Lot 6B — F1, F2, F3, F4 matérialisés (100 %) ; F5 en cours (F5.1→F5.4 faits)"
...
| **F5 — Production** | [`source/production/`](source/production/) → [01](source/production/01-runtime.md) · [02](source/production/02-persistence.md) · [03](source/production/03-observability.md) · [04](source/production/04-security.md) | **en cours** (Lot 6B : F5.1→F5.4 faits) |
