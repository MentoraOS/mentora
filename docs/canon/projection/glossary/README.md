---
doc: canon-projection-glossary
title: Glossaire Officiel
type: projection
titre: canon
statut: "Projeté — R2-Projections Lot 1"
...
Contenant de la projection **Glossaire** (bilingue :
métier FR / code EN, termes réservés). Projection déterministe de la Source
(F2 pour le métier, F5 pour la Production ; F5.99 pour « propriété émergente »),
jamais une source autonome.
...
> Source (fail closed) est le **Vocabulary Diff** (Lot 2). Les énumérations
> exhaustives relèvent des **Catalogues** (Lot 4).
