...
type: apparatus
titre: canon
statut: "R2-Corpus Lot 5A — F1, F2, F3 matérialisés (100 %) ; F4 en cours (F4.1 fait) ; F5 en attente"
...
| **F4 — Exécution** | [`source/application/`](source/application/) → [01](source/application/01-application-core-sequence.md) | **en cours** (Lot 5A : F4.1 fait) |
