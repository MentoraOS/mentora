...
type: apparatus
titre: canon
statut: "R2-Corpus Lot 6A — F1, F2, F3, F4 matérialisés (100 %) ; F5 en cours (F5.1, F5.2 faits)"
...
| **F5 — Production** | [`source/production/`](source/production/) → [01](source/production/01-runtime.md) · [02](source/production/02-persistence.md) | **en cours** (Lot 6A : F5.1, F5.2 faits) |
