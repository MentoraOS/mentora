...
export const RULE_CATALOG: readonly RuleCatalogEntry[] = [
  ...
  },
  {
    code: 'MENTORA0005',
    name: 'query-naming',
    description: 'Declarations ending in Query must carry a named truth/aspect (≥ 1 word before the suffix) — the ratified catalogue includes single-stem reads (MembershipQuery).',
    ...
    valid: ['ConsentValidityQuery', 'AgreementStateQuery', 'MembershipQuery'],
    invalid: ['Query'],
  },
  {
    code: 'MENTORA0006',
    name: 'policy-naming',
    description: 'Declarations ending in Policy must carry a named rule (≥ 1 word before the suffix) — the ratified catalogue includes single-stem policies (ReschedulePolicy, ConfirmationPolicy, F3.3 §6).',
    ...
    valid: ['AgreementCancellationPolicy', 'ReschedulePolicy', 'ConfirmationPolicy'],
    invalid: ['Policy'],
  },
  {
    code: 'MENTORA0007',
