---
doc: canon-source
title: Source — le Corpus Canonique
type: source
titre: canon
...
**Source** est le lieu unique de vérité : les Titres **F1 → F5** ratifiés et
...
| F5 — Production | [`production/`](production/) | **en cours** (Lot 6 ; F5.1→F5.8 faits ; reste F5.99) |
